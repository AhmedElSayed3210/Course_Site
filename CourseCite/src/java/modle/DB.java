...
public class DB {
    ...
    private static Connection conn(){
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
             con=DriverManager.getConnection("jdbc:mysql://localhost:3306/coursesite","root","root");
    ...
    return con;
     ...
     public  boolean usersearch(String username,String pass){
        ...
        boolean flag=false;
        try {
            PreparedStatement ps=conn().prepareStatement("select * from admintable where username=? and password=?");
     ...
     public  boolean addcourse(String cname,String cdetails,String cdate,String chour,String cteacher,String clocation){
        ...
        boolean flag=false;
        try {
            String sql="insert into courses (cname , cdetails, cdate,chour,cteacher,clocation) values (? ,?,?,?,?,?)";
     ...
     public    List<course> selectallcourses(){
        ...
        try {
            ...
            c.setCname(set.getString(6));
            c.setCdetails(set.getString(2));
            c.setCdate(set.getString(3));
            c.setChour(set.getString(4));
            c.setCteacher(set.getString(5));
    ...
    return list;
     ...
     public  int editecourse(course c){
        ...
        try {
            ...
            String sql="update courses set cname=? , cdetails=? ,cdate=?,chour=?,cteacher=? ,clocation=? where id =?";
            PreparedStatement ps=conn().prepareStatement(sql);
    ...
    return x;
     ...
     public  boolean addstudent(String name,String phone,String mail,String eduction,String cname){
        ...
        boolean flag=false;
        try {
            String sql="insert into student (name , phone, mail,eduction,cname) values (? ,?,?,?,?)";
            PreparedStatement ps=conn().prepareStatement(sql);
            ps.setString(1, name);
